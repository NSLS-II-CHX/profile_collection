...
#print('Taking a sime example scan with xray_eye3:')
...
#img = get_images(db[uid_scan], 'xray_eye3_image');
#print('timestamp issue needs to be fixed...')
#plt.imshow( img[0] )
print('skipping image read');

#print('Taking a  alignment scans (with the elm):')
